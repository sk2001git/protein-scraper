// my-worker/.wrangler/tmp/bundle-1vxykh/checked-fetch.js
...
var src_default = {
      ...
      try {
        const response = await fetch(url, {
          ...
          headers: {
            ...
            // Include your secret token here
          }
        });
        if (!response.ok) {
  ...
  async fetch(request) {
    return new Response("This worker is for scheduled tasks only.", {
      status: 200,
      headers: {
...
// my-worker/.wrangler/tmp/bundle-1vxykh/middleware-insertion-facade.js
...
// my-worker/.wrangler/tmp/bundle-1vxykh/middleware-loader.entry.ts
